...
const CustomerList=()=>{
  ...
  useEffect(()=>{
    const getCustomerData = async () => {
      ...
      const API_URL = process.env.REACT_APP_API_URL || "https://customerserver-10.onrender.com";

const apiUrl = `${API_URL}/api/customers?page=${page}&order_by=${orderBy}&search_q=${search}`;
